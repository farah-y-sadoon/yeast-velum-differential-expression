...
During the sherry production process, flor yeast undergoes major physiological changes to adapt to the changing environmental conditions (41). Over the course of the process, biofilm develops as a stress response to changing alcohol and sugar conditions (Table 1, 18, 42). The yeast samples for this analysis were extracted at three stages of development, where ethanol, glycerol, and glucose were progressively depleted, and aldehydes steadily increased through early, thin, and mature biofilm stages (Table 1, 18). The intensifying chemical conditions of the substrate require structural and metabolic reprogramming of the *S. cerevisiae* transcriptome to ensure survival (41). Interestingly, specific genes involved in cell adhesion, nutrient acquisition, and membrane structure display significant shifts in biological processes and metabolic pathways (Figure 5, Figure 6).​ 
...
Fructose (g/l) | 0.3 | 0.2 | 0.2
Oligosaccharides (g/l) | 0.3 | 0.2 | 0.2
Glycerol (g/l) | 8.5 | 7.9 | 6.8

Table 1. Chemical composition of wine samplings from Mardanov and colleagues’ 2020 study on the transcriptomic profile of flor yeast across biofilm development stages (18). *Expressed in grams of tartaric acid per liter. **Expressed in grams of acetic acid per liter.

Differential expression analysis identified *FLO11* transcripts as significantly upregulated from the early to the mature developmental stage (Figure 5). *FLO11* encodes a protein involved in yeast flocculation, a process where yeast aggregates into clusters (43). In particular, it has been found to increase cell surface hydrophobicity, allowing yeast cells to float to the top of the air-liquid interface and adhere to each other, forming flor, or biofilm (44). Here, *FLO11* transcripts shift from low relative abundance in the early stage to significant upregulation as the biofilm matures (Figure 5); this observation suggests that between the early and thin stage of biofilm development, a trigger causes *FLO11* regulation to change drastically to promote survival in a new environment. Previous work has identified that glucose represses flor formation in wild *S. cerevisiae* strains, and that this feature is specifically associated with a deletion in the *FLO11* promoter region that is also characteristic of strains specific to sherry production (45). Between the early and thin biofilm conditions of the current analysis, glucose levels decreased from 0.2g/l to 0.1g/l, indicating a potential regulatory threshold within this range (Table 1, 18).

In contrast, DGE revealed that *OLE1* transcripts were significantly downregulated between early and mature biofilm stages (Figure 5). *OLE1* produces a protein involved in unsaturated fatty acid (UFA) production and is critical for mediating membrane fluidity in conditions with high ethanol content (46, 47). While highly tolerant strains of *S. cerevisiae* upregulate OLE to mitigate the effects of ethanol stress, *OLE1* was downregulated between the early and mature stages of development. Interestingly, ethanol concentration decreased (12.4% to 9.6% v/v, 47, Table 1, 18) between stages, suggesting that once ethanol-induced stress reduces, the *OLE1* gene and the associated “fatty acid biosynthesis” pathway are downregulated to conserve energy for other processes (Figure 5, Figure 6B).
